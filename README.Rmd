...
- The `data` parameter can either be an _url_ to fetch data from or an _data object_
...
just use the `JS` function in R to pass it to the layer object. In the example above this is done for the properties `getPosition` and `onHover`.
